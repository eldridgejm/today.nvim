...
describe("dateobj", function()
    ...
    describe("infinite_past", function()
        it("should serialize to infinite_past", function()
            assert.are.equal(tostring(DateObj:infinite_past()), "infinite_past")
        end)
    end)
    ...
    describe("add_days", function()
        ...
        it(
            "should return infinite_past when days are added to infinite_past",
            function()
    ...
    describe("ymd", function()
        ...
        it("should return nil if infinite_past", function()
            assert.are.equal(DateObj:infinite_past():ymd(), nil)
        end)
    end)
    ...
    describe("days_until", function()
        ...
        it("should return -math.huge if other is infinite_past", function()
            local ds = DateObj:from_ymd(2021, 7, 4)
            assert.are.equal(ds:days_until(DateObj:infinite_past()), -math.huge)
        end)
        ...
        it("should return -math.huge infinite_past to infinite_future", function()
            local ds1 = DateObj:infinite_past()
            local ds2 = DateObj:infinite_future()
            assert.are.equal(ds2:days_until(ds1), -math.huge)
        end)
    end)
    ...
    describe("day_of_the_week", function()
        it("should return nil if date is infinite", function()
            ...
            assert.are.equal(ds2:day_of_the_week(), nil)
        end)

        it("should return the day of the week as a number, with sunday == 1", function()
