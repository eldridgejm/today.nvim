...
describe("natural language to date", function()
    ...
    describe("datestamp", function()
        ...
        it("works for november", function()
            assert.are.equal(
                dateslib.parse("sat nov 20 2021", DateObj:new("2021-1-1")),
                DateObj:new("2021-11-20")
            )
        end)

        it("works for date far in the future", function()
            assert.are.equal(
                dateslib.parse("sat nov 20 2028", DateObj:new("2021-1-1")),
                DateObj:new("2028-11-20")
            )
        end)
